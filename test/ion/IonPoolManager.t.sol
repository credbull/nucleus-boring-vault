...
contract IonPoolManagerForkTest is IonPoolSharedSetup {
    ...
    function test_ManageIonPoolSupply_CorrectAddress() public {
        ...
        targetData[0] =
            abi.encodeWithSelector(WEETH_IONPOOL.supply.selector, address(boringVault), supplyAmt, whitelistProof);
        ...
        assertApproxEqAbs(
            WEETH_IONPOOL.balanceOf(address(boringVault)), supplyAmt, roundingError, "boringVault supplied to IonPool"
        );
    }
